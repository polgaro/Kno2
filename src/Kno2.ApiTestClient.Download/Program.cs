...
namespace Kno2.ApiTestClient.Download
{
    ...
    {
        public static void AsBanner(this string x, ConsoleColor c, bool b1 = false, bool b2 = false)
        {

        }

        public static void AsInlineBanner(this string x, ConsoleColor c)
        {

        }
        public static void AsClosingBanner(this string x, ConsoleColor c)
        {

        }
        public static void ToConsole(this string x, ConsoleColor c)
        {

        }
        public static void AsOpeningBanner(this string x, ConsoleColor c, bool b1 = false, bool b2 = false, bool b3 = false, bool b4 = false)
        {

        }
        public static void HeaderLine(bool b)
        {

        }

        internal static void HeaderLine(ConsoleColor light)
        {
